...
insert into products (id, name, description, price, image, categoryId, discount, color) values (1, 'CEPILLO DE DIENTES DE BAMBU VEGANO', 'description of product', 1306.55, 'product_1.jpg', 8, 37, 'Mauv');
insert into products (id, name, description, price, image, categoryId, discount, color) values (2, 'PERFUME SÓLIDO', 'description of product', 1210.05, 'product_2.jpg', 4, 7, 'Pink');
insert into products (id, name, description, price, image, categoryId, discount, color) values (3, 'BÁLSAMO LABIAL LAVANDA', 'description of product', 1127.21, 'product_3.jpg', 8, 2, 'Puce');
insert into products (id, name, description, price, image, categoryId, discount, color) values (4, 'JABONERAS DE PINO AL NATURAL', 'description of product', 269.77, 'product_4.jpg', 4, 41, 'Crimson');
insert into products (id, name, description, price, image, categoryId, discount, color) values (5, 'DESODORANTE EN CREMA', 'description of product', 2210.12, 'product_5.jpg', 6, 4, 'Orange');
insert into products (id, name, description, price, image, categoryId, discount, color) values (6, 'SERUM CAPILAR', 'description of product', 711.39, 'product_6.jpg', 5, 13, 'Turquoise');
insert into products (id, name, description, price, image, categoryId, discount, color) values (7, 'KIT AVANZADO', 'description of product', 408.33, 'product_7.jpg', 7, 7, 'Yellow');
insert into products (id, name, description, price, image, categoryId, discount, color) values (8, 'KIT CAPILAR', 'description of product', 1667.07, 'product_8.jpg', 7, 48, 'Goldenrod');
insert into products (id, name, description, price, image, categoryId, discount, color) values (9, 'PASTA DENTAL', 'description of product', 939.28, 'product_9.jpg', 8, 15, 'Mauv');
insert into products (id, name, description, price, image, categoryId, discount, color) values (10, 'SHAMPOO LAVANDA', 'description of product', 1173.91, 'product_10.jpg', 1, 9, 'Crimson');
insert into products (id, name, description, price, image, categoryId, discount, color) values (11, 'BALSAMO MIEL', 'description of product', 1662.53, 'product_11.jpg', 2, 33, 'Mauv');
insert into products (id, name, description, price, image, categoryId, discount, color) values (12, 'SHAMPOO CABELLO GRASO', 'description of product', 257.71, 'product_12.jpg', 3, 25, 'Fuscia');
insert into products (id, name, description, price, image, categoryId, discount, color) values (13, 'HISOPOS DE MADERA', 'description of product', 1926.72, 'product_13.jpg', 1, 25, 'Indigo');
insert into products (id, name, description, price, image, categoryId, discount, color) values (14, 'PEINE DE BAMBU', 'description of product', 2031.64, 'product_14.jpg', 6, 2, 'Goldenrod');
insert into products (id, name, description, price, image, categoryId, discount, color) values (15, 'CREMA UN LITRO', 'description of product', 2283.07, 'product_15.jpg', 1, 22, 'Orange');
insert into products (id, name, description, price, image, categoryId, discount, color) values (16, 'LABIAL CHOCOLATE', 'description of product', 317.94, 'product_16.jpg', 7, 37, 'Crimson');
insert into products (id, name, description, price, image, categoryId, discount, color) values (17, 'KIT HIGIENE', 'description of product', 1846.03, 'product_17.jpg', 8, 2, 'Purple');
insert into products (id, name, description, price, image, categoryId, discount, color) values (18, 'SERUM ALOE VERA', 'description of product', 2150.15, 'product_18.jpg', 6, 50, 'Blue');
insert into products (id, name, description, price, image, categoryId, discount, color) values (19, 'CREMA PARA MANOS', 'description of product', 1806.92, 'product_19.jpg', 2, 5, 'Green');
insert into products (id, name, description, price, image, categoryId, discount, color) values (20, 'CREMA PARA PIES', 'description of product', 211.11, 'product_20.jpg', 1, 18, 'Green');
